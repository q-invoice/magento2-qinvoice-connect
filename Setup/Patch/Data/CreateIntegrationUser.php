...
{
    const Q_INVOICE_INTEGRATION_NAME = 'qinvoice';
    ...
    public function apply()
    {
        ...
        try{
            $this->configBasedIntegrationManager->processConfigBasedIntegrations([self::Q_INVOICE_INTEGRATION_NAME => array('resource' => 1)]);
